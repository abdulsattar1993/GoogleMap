...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback,ActivityCompat.OnRequestPermissionsResultCallback, GoogleApiClient.ConnectionCallbacks, LocationListener,GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initMap();
        Toast.makeText(getApplicationContext(), "Map initialized...Please Wait", Toast.LENGTH_LONG).show();
    ...
    public void geoLocate(View view) throws IOException {
        ...
        Toast.makeText(getApplicationContext(), "We find location for you ", Toast.LENGTH_LONG).show();
    ...
    private void setMarker(String locality, double lat, double lon) {
        ...
        BitmapDrawable bitmapdraw=(BitmapDrawable)getResources().getDrawable(R.drawable.uzair);
     ...
     * we just add a marker near islamabad, Pakistan.
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng islamabad = new LatLng(33.7294, 73.0931);
        mGoogleMap.addMarker(new MarkerOptions().position(islamabad).title("Marker in Islamabad"));
        mGoogleMap.moveCamera(CameraUpdateFactory.newLatLng(islamabad));
    }
